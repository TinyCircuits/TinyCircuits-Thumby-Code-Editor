...
def clearScreen():
  ...
  thumby.display.drawFilledRectangle(34,2,36,12 ,0)
  thumby.display.drawFilledRectangle(39-5,18,14,12,0)
  thumby.display.drawFilledRectangle(52,18,18,12,0)
  
  thumby.display.drawRectangle(34-1,2-1,36+2,12+2,1)
  thumby.display.drawRectangle(39-1-5,18-1,14+2,12+2,1)
  thumby.display.drawRectangle(52-1,18-1,18+2,12+2,1)

def setBlock(xb, yb, val):
  thumby.display.drawFilledRectangle(xb*2, yb*2, 2, 2, val)
...
def updateScreen():
  ...
  thumby.display.drawText('%04d' % (points//10), 36, 5,1)
  thumby.display.drawText('%02d' % lines_cleared, 36+18-1, 21,1)
  # level
...
def show_high_score():
  ...
  for i in range(41):
    ...
    thumby.display.drawText("G", 9, -2+5+0,1)
    thumby.display.drawText("A", 9, -2+5+8,1)
    thumby.display.drawText("M", 9, -2+5+16,1)
    thumby.display.drawText("E", 9, -2+5+24,1)
    thumby.display.drawText("O", 19, 2+5+0,1)
    thumby.display.drawText("V", 19, 2+5+8,1)
    thumby.display.drawText("E", 19, 2+5+16,1)
    thumby.display.drawText("R", 19, 2+5+24,1)
    time.sleep_ms(10)
    thumby.display.update()
...
while(True):
  ...
  thumby.display.fill(0)
  thumby.display.blit(tetrisSplash, 0,0, 72, 40,0,0,0)
  #thumby.display.update()
  #while(1):
  #    a=1
