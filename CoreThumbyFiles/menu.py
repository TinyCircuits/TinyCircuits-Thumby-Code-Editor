#this 4 strokes needed for battery and some on 373 stroke
import math
...
try:
    ...
    if(len(conf)<8):
        conf.append(',brightness,2,batterydispmode,0')
except OSError:
...
while True:
    ...
    #this 14 strokes for percent of battery and upper 3-5 strokes
